-- etl/fixes/complete_ema_rebuild_fixed.sql
-- Purpose: Complete rebuild of EMAs from 2021-2025 with outlier detection (fixed version)
-- Handles data entry errors and scale malfunctions by excluding extreme values

-- Step 1: Backup current data
CREATE TABLE IF NOT EXISTS daily_series_backup_with_outliers_v2 AS
...
-- Step 6: Verify no large jumps remain (fixed version)
